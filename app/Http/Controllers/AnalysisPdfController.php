...
use App\Service\AnalysisPdfService;
...
{
    protected AnalysisPdfService $service;
    ...
    public function prepare()
    {
        ...
        return view('dashboard.prepare', get_defined_vars());
    }
    ...
    public function view()
    {
        ...
        return view('dashboard.analysisPdf', get_defined_vars());
    }

    public function viewPost(Request $request): Factory|View|Application
    {
        executionTime();
    ...
    public function download()
    {
        ...
        $test = 0.50;
        $pdf = SnappyPdf::loadView('dashboard.analysisPdf', get_defined_vars());
