...
class BrandActivityRepository extends BasicRepository
{
    /**
     * @var array
     */
    protected array $fieldSearchable = [
        'id','date_from', 'date_to', 'city_id', 'country_id', 'tag_id', 'subject', 'brief','event_location'
    ];
    ...
    public function save(Request $request, $id = null)
    {
        return DB::transaction(function () use ($request, $id) {
            ...
            $data->sponsorship()->sync((array)$request->sponsorship);
            return $data;
        });
    }
}
