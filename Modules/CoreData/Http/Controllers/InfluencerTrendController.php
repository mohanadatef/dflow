...
use Modules\CoreData\Export\ExportInfluencerTrend;
use Modules\CoreData\Http\Requests\InfluencerTrend\CreateRequest;
use Modules\CoreData\Http\Requests\InfluencerTrend\EditRequest;
use Modules\CoreData\Service\InfluencerTrendService;
...
class InfluencerTrendController extends BasicController
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax())
        {
            return view(checkView('coredata::influencer_trend.table'), get_defined_vars());
        }
        return view(checkView('coredata::influencer_trend.index'), get_defined_vars());
    }
    ...
    public function create(Request $request)
    {
        ...
        return view(checkView('coredata::influencer_trend.create'),get_defined_vars());
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view(checkView('coredata::influencer_trend.edit'), get_defined_vars());
    }
