    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">Interest</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_interest_create_form" class="form" method="post" action="{{route('interest.store')}}">
                @csrf
                <!--begin::Card body-->
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\Interest\CreateRequest','#kt_interest_create_form') !!}
@endpush
