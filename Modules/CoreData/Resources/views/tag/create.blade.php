    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{getCustomTranslation('tag')}}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_tag_create_form" class="form" method="post" action="{{route('tag.store')}}">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <input type="text" name="name_en" value="{{Request::old('name')}}"
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\Tag\CreateRequest','#kt_tag_create_form') !!}
@endpush
