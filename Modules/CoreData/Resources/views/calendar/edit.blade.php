...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_calendar_edit" aria-expanded="true"
             aria-controls="kt_calendar_edit">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_calendar_edit_form" class="form" method="post" action="{{route('calendar.update',$data->id)}}">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="date" name="from" value="{{ date('Y-m-d',strtotime($data->from)) }}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                    />
                                </div>
                                <!--end::Col-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="date" name="to" value="{{ date('Y-m-d',strtotime($data->to)) }}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                    />
                                </div>
                                <!--end::Col-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="text" name="campaign" value="{{$data->campaign}}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_calendar_edit_submit">{{getCustomTranslation('save_changes')}}
                    </button>
                </div>
                <!--end::Actions-->
            </form>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\Calendar\EditRequest','#kt_calendar_edit_form') !!}
@endpush
