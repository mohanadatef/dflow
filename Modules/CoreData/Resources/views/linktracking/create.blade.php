    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{getCustomTranslation('link_tracking')}}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_linktracking_create_form" class="form" method="post"
                  action="{{ route('linktracking.store') }}">
                @csrf
                <!--begin::Card body-->
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 fv-row">
                                    <input type="url" name="destination" value="{{ Request::old('destination')??"https://" }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 fv-row">
                                    ...
                                    ></select>
                                    @if ($errors->has('influencer_id'))
                                        <div>
                                            <p class="invalid-input">{{ $errors->first('influencer_id') }}</p>
                                        </div>
                                    @endif
                                </div>
                                <!--end::Col-->
                                        ...
                                        <div data-repeater-item class="mt-5">
                                            <div class="form-group row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control mb-2 mb-md-0" name="country_id" id="">
                                                ...
                                                <div class="col-md-2">
                                                    <a href="javascript:;" data-repeater-delete
                                                       class="btn btn-sm btn-light-danger mt-3 mt-md-8"><i class="la la-trash-o"></i>{{getCustomTranslation('delete')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mb-6 mt-5">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="row">
                                        <!--begin::Col-->
                                        <div class="col-lg-10 fv-row">
                                            <input type="url" name="ios_url" value="{{ Request::old('ios_url') }}"
                                                   class="form-control  form-control-solid mb-3 mb-lg-0"
                                                   placeholder="https://www.example.com"/>
                                        </div>
                                        <!--end::Col-->
                            ...
                            <div class="row mb-6 mt-5">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="row">
                                        <!--begin::Col-->
                                        <div class="col-lg-10 fv-row">
                                            <input type="url" name="mac_url" value="{{ Request::old('mac_url') }}"
                                                   class="form-control  form-control-solid mb-3 mb-lg-0"
                                                   placeholder="https://www.example.com"/>
                                        </div>
                                        <!--end::Col-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 fv-row">
                                    <textarea type="text" name="note"
                                              class="form-control  form-control-solid mb-3 mb-lg-0">{{ Request::old('note') }}</textarea>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_linktracking_create_submit">{{getCustomTranslation('submit')}}
                    </button>
                </div>
                <!--end::Actions-->
            </form>
...
@push('scripts')
    <script>
        var route = "{{ route('linktracking.index') }}";
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\Linktracking\CreateRequest','#kt_linktracking_create_form',) !!}
