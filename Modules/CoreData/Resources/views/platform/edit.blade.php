...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_platform_create" aria-expanded="true"
             aria-controls="kt_platform_create">
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{getCustomTranslation('platform')}} {{getCustomTranslation('details')}}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_platform_edit_form" class="form" method="post" action="{{route('platform.update',$data->id)}}"
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">{{getCustomTranslation('order')}}</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <!--begin::Row-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <select name="service[]" aria-label="{{getCustomTranslation('select_a_service')}}" data-control="select2"
                                            multiple="multiple" data-placeholder="{{getCustomTranslation('select_a_service')}}..."
                                            class="form-select form-select-solid form-select-lg fw-semibold">
                                        <option value="">{{getCustomTranslation('select_a_service')}}...</option>
                                        @foreach($service as $value)
                                            <option
                                                @if(in_array($value->id,$data->service->pluck('id')->toArray())) selected
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-125px h-125px"
                                     style="background-image: url('{{ getFile($data->icon->file??null,pathType()['ip'],getFileNameServer($data->icon))  }}')"></div>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\Platform\EditRequest','#kt_platform_edit_form') !!}
@endpush
