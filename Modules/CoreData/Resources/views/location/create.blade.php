...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_location_create" aria-expanded="true"
             aria-controls="kt_location_create">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_location_create_form" class="form" method="post" action="{{route('location.store')}}">
                @csrf
                <!--begin::Card body-->
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\Location\CreateRequest','#kt_location_create_form') !!}
@endpush
