        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text"
                           ...
                           placeholder="{{getCustomTranslation('search_category')}}"
            ...
            <div class="card-toolbar">
                @if(!$userType == 1)
                    ...
                    <!--begin::Menu 1-->
                    <form method="GET" id="filterDataForm" action="{{route('category.index')}}"
                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                            ...
                            <div class="mb-10">
                                <!--begin::Label-->
                                <label class="form-label fw-semibold">{{getCustomTranslation('group')}}:</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div>
                                    <select id="searchSelect" class="form-select form-select-solid" name="group"
                                            data-kt-select2="true" data-placeholder="{{getCustomTranslation('select_option')}}">
                                        <option value="">{{getCustomTranslation('all')}}</option>
                                        @foreach(groupType() as $groupType)
                                        <option {{ request()->group == $groupType ? "selected" : ""}} value="{{$groupType}}">{{getCustomTranslation($groupType)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!--end::Input-->
              ...
              {{getCustomTranslation('export')}}
                ...
                <!--begin::Toolbar-->
                <div class="d-flex justify-content-end" data-kt-category-table-select="base">
                    @can('create_categories')
                    <!--begin::Add customer-->
                    <a href="{{ route('category.create') }}" class="btn btn-primary">{{getCustomTranslation('add')}} {{getCustomTranslation('category')}}</a>
                    <!--end::Add customer-->
                    @endcan
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                <div class="d-flex justify-content-end align-items-center" data-kt-category-table-select="selected">
                    <div class="fw-bold me-5">
                        {{-- <span class="me-2" data-kt-customer-table-select="selected_count"></span>Selected</div> --}}
                        @can('delete_categories')
                        <button type="button" class="btn btn-danger ms-1 "
                                data-kt-category-table-select="delete_selected">{{getCustomTranslation('delete_selected')}}
                        </button>
                        @endcan
                    </div>
                    <!--end::Group actions-->
...
@push('scripts')
    ...
    <script>
        ...
        function exportData(lang) {
            ...
            location.href = "{{ route('category.export' )}}?" + jQuery.param(params);
        }
