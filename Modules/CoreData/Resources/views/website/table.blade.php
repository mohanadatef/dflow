                    ...
                    <td class="text-end">
                        ...
                        <div
                            ...
                            <div class="menu-item px-3">
                                @can('update_websites')
                                <a href="{{route('website.edit',['id'=>$category->id])}}"
                            ...
                            <div class="menu-item px-3">
                                @can('delete_websites')
                                <a href="#" data-kt-links-table-filter="delete_row"
...
{{ $websites->appends($_GET)->links('dashboard.layouts.pagination', ['paginator' => $websites,'perPage' =>Request::get('perPage') ?? $websites->perPage()]) }}
