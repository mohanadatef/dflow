...
@section('content')
    ...
    <div class="card card-flush">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text"
                           id="search"
                           data-kt-event-table-filter="search" class="form-control form-control-solid w-250px ps-15"
                           placeholder="{{getCustomTranslation('search')." ".getCustomTranslation('event')}}"
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Menu 1-->
                <form method="GET" id="filterDataForm" action="{{route('event.index')}}"
                    ...
                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('event.index') }}" id="reset_filter"
                ...
                <!--begin::Toolbar-->
                <div class="d-flex justify-content-end" data-kt-event-table-select="base">
                    @can('create_event')
                        <!--begin::Add customer-->
                        <a href="{{ route('event.create') }}"
                           class="btn btn-primary">{{getCustomTranslation('add')}} {{getCustomTranslation('event')}}</a>
                        <!--end::Add customer-->
                    @endcan
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                <div class="d-flex justify-content-end align-items-center" data-kt-event-table-select="selected">
                    <div class="fw-bold me-5">
                        {{-- <span class="me-2" data-kt-customer-table-select="selected_count"></span>Selected</div> --}}
                        @can('delete_event')
                            <button type="button" class="btn btn-danger ms-1 "
                                    data-kt-event-table-select="delete_selected">{{getCustomTranslation('delete_selected')}}
                            </button>
                        @endcan
                    </div>
                    <!--end::Group actions-->
        ...
        <div class="card-body pt-0" id="data">
            <!--begin::Table-->
            @include('coredata::event.table')
        </div><!--end::Datatable-->
    </div><!--end::Products-->
@endsection
@push('scripts')
    <script>
        let route = "{{ route('event.index') }}";
        var searchVal = $("#search").val().trim();//?search="+searchVal+"&"+ "perPage=" + limit +"&"
        let csrfToken = "{{ csrf_token() }}";
        let deletePermission = {{permissionShow('delete_event') ? 1 : 0}};
        let updatePermission = {{permissionShow('update_event') ? 1 : 0}};
        limit = "{{Request::get('perPage') ?? $dates->perPage()}}";
    </script>
    <script src="{{ asset('dashboard') }}/assets/js/event/list.js"></script>
    <script>
        ...
        function exportData(lang) {
            ...
            location.href = "{{ route('event.export' )}}?" + jQuery.param(params);
        }
