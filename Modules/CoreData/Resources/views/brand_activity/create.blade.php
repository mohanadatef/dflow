...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_brand_activity_create" aria-expanded="true"
             aria-controls="kt_brand_activity_create">
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{getCustomTranslation('brand_activity')}}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_brand_activity_create_form" class="form" method="post"
                  action="{{route('brand_activity.store')}}">
                @csrf
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{getCustomTranslation('event_location')}}</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <!--begin::Row-->
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="text" name="event_location" value="{{Request::old('event_location')}}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                           placeholder="{{getCustomTranslation('event_location')}}"/>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="datetime-local" name="date_from" value="{{Request::old('date_from')}}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="datetime-local" name="date_to" value="{{Request::old('date_to')}}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    ...
                                    >
                                        @php $influencer_data = \Modules\Acl\Entities\Influencer::find(Request::old('influencer')); @endphp
                                        @if($influencer_data)
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{getCustomTranslation('sponsorship')}}</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <!--begin::Row-->
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    <select id="sponsorship" name="sponsorship[]"
                                            ...
                                            data-mce-placeholder="" multiple
                                    >
                                        @php $sponsorship_data = \Modules\Acl\Entities\Influencer::find(Request::old('sponsorship')); @endphp
                                        @if($sponsorship_data)
                                            @foreach($sponsorship_data as $sponsorship)
                                                <option value="{{$sponsorship->id}}"
                                                        selected>{{$sponsorship->name_en ."/". $sponsorship->name_ar}}
                                                </option>
                                            @endforeach
                                        @endif
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{  route('brand_activity.index') }}"
                       class="btn btn-light btn-active-light-primary me-2">{{getCustomTranslation('discard')}}</a>
                    <button type="submit" class="btn btn-primary"
                            id="kt_brand_activity_create_submit">{{getCustomTranslation('save_changes')}}
                    </button>
                </div>
                <!--end::Actions-->
            </form>
...
@push('scripts')
    ...
    <script>
        var route = "{{ route('brand_activity.index') }}";
