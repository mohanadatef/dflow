    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_brand_activity_create_form" class="form" method="post"
                  action="{{route('brand_activity.update',$data->id)}}">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="text" name="event_location" value="{{$data->event_location}}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    <select id="sponsorship" name="sponsorship[]"
                                            ...
                                            data-mce-placeholder="" multiple
                                    >
                                        @php $sponsorship_data = \Modules\Acl\Entities\Company::find($data->sponsorship->pluck('id')->toArray()); @endphp
                                        @if($sponsorship_data)
