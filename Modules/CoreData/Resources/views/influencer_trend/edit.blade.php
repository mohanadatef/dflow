    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_influencer_trend_create_form" class="form" method="post"
                  action="{{route('influencer_trend.update',$data->id)}}">
                @csrf
                <!--begin::Card body-->
                                ...
                                <div class="col-lg-6 fv-row">
                                    <select name="audience_impression" aria-label="audience_impression"
                                        ...
                                        @foreach(audienceImpressionType() as $value)
                                            <option value="{{$value}}"
                                                    @if($value == $data->audience_impression) selected @endif>{{getCustomTranslation($value)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!--end::Col-->
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    ...
                                    >
                                        @php $influencer_data = \Modules\Acl\Entities\Influencer::find($data->influencer_id); @endphp
                                        @if($influencer_data)
