    ...
    <div class="card card-flush">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-promotion-type-table-filter="search"
            ...
            <div class="card-toolbar">
              ...
              {{getCustomTranslation('export')}}
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-select="base">
                    ...
                    <!--begin::Add customer-->
                    <a href="{{ route('promotion_type.create') }}" class="btn btn-primary">{{getCustomTranslation('add')}} {{getCustomTranslation('promotion_type')}}</a>
                    <!--end::Add customer-->
                    @endcan
                </div>
                <!--end::Toolbar-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_promotion-type_table">
                    <!--begin::Table head-->
                    <thead>
                    <!--begin::Table row-->
                        ...
                        <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                       data-kt-check-target="#kt_promotion-type_table .form-check-input" value="1"/>
                            </div>
                        </th>
        ...
        @push('scripts')
            ...
            <script>
                ...
                var routeAll = "{{ route('promotion_type.index',Request()->all()) }}";
                var csrfToken = "{{ csrf_token() }}";
                var deletePermission = {{permissionShow('delete_promotions') ? 1 : 0}};
                var updatePermission = {{permissionShow('update_promotions') ? 1 : 0}};
                function exportData(lang) {
                    var params = {
                        lang: lang,
                    };
                    location.href = "{{ route('promotion_type.export' )}}?" + jQuery.param(params);
                }
            </script>
            <script src="{{ asset('dashboard') }}/assets/js/promotion_type/list.js?v=1"></script>
    @endpush
