...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_promotion_type_edit" aria-expanded="true"
             aria-controls="kt_promotion_type_edit">
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{getCustomTranslation('promotion_type')}} {{getCustomTranslation('details')}}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_promotion_type_edit_form" class="form" method="post"
                  action="{{route('promotion_type.update',$data->id)}}">
                @csrf
                <!--begin::Card body-->
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_promotion_type_edit_submit">{{getCustomTranslation('save_changes')}}
                    </button>
                </div>
                <!--end::Actions-->
            </form>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\PromotionType\EditRequest','#kt_promotion_type_edit_form') !!}
@endpush
