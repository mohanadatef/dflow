...
@section('title', getCustomTranslation('city'))
...
@section('content')
    ...
    <div class="card card-flush">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-select="base">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        <!--end::Svg Icon-->{{getCustomTranslation('add')}}{{getCustomTranslation('city')}}
                    </button>
                    <!--end::Add city-->
                    @endcan
                </div>
        ...
        <!--end::Products-->
        @include('coredata::cities.create')
        @include('coredata::cities.edit')
        @endsection
        @push('scripts')
            <script>
            ...
            <script src="{{ asset('dashboard') }}/assets/js/cities/list.js?v=1"></script>
            <script src="{{ asset('dashboard') }}/assets/js/cities/add.js"></script>
            <script src="{{ asset('dashboard') }}/assets/js/cities/update.js"></script>
    @endpush
