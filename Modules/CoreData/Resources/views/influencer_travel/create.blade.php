...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_influencer_travel_create" aria-expanded="true"
             aria-controls="kt_influencer_travel_create">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_influencer_travel_create_form" class="form" method="post"
                  action="{{route('influencer_travel.store')}}">
                @csrf
                <!--begin::Card body-->
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary"
                            id="kt_influencer_travel_create_submit">{{getCustomTranslation('save_changes')}}
                    </button>
                </div>
                <!--end::Actions-->
            </form>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\CoreData\Http\Requests\InfluencerTravel\CreateRequest','#kt_influencer_travel_create_form') !!}
@endpush
