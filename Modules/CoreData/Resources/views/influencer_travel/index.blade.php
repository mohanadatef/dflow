...
@section('content')
    ...
    <div class="card card-flush">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text"
                           id="search"
                           data-kt-influencer_travel-table-filter="search" class="form-control form-control-solid w-250px ps-15"
                           placeholder="{{getCustomTranslation('search')." ".getCustomTranslation('influencer_travel')}}"
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Menu 1-->
                <form method="GET" id="filterDataForm" action="{{route('influencer_travel.index')}}"
                    ...
                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('influencer_travel.index') }}" id="reset_filter"
                ...
                <!--begin::Toolbar-->
                <div class="d-flex justify-content-end" data-kt-influencer_travel-table-select="base">
                    @can('create_influencer_travel')
                        <!--begin::Add customer-->
                        <a href="{{ route('influencer_travel.create') }}"
                           class="btn btn-primary">{{getCustomTranslation('add')}} {{getCustomTranslation('influencer_travel')}}</a>
                        <!--end::Add customer-->
                    @endcan
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                <div class="d-flex justify-content-end align-items-center" data-kt-influencer_travel-table-select="selected">
                    <div class="fw-bold me-5">
                        {{-- <span class="me-2" data-kt-customer-table-select="selected_count"></span>Selected</div> --}}
                        @can('delete_influencer_travel')
                            <button type="button" class="btn btn-danger ms-1 "
                                    data-kt-influencer_travel-table-select="delete_selected">{{getCustomTranslation('delete_selected')}}
                            </button>
                        @endcan
                    </div>
                    <!--end::Group actions-->
        ...
        <div class="card-body pt-0" id="data">
            <!--begin::Table-->
            @include('coredata::influencer_travel.table')
        </div><!--end::Datatable-->
    </div><!--end::Products-->
@endsection
@push('scripts')
    <script>
        let route = "{{ route('influencer_travel.index') }}";
        var searchVal = $("#search").val().trim();//?search="+searchVal+"&"+ "perPage=" + limit +"&"
        let csrfToken = "{{ csrf_token() }}";
        let deletePermission = {{permissionShow('delete_influencer_travel') ? 1 : 0}};
        let updatePermission = {{permissionShow('update_influencer_travel') ? 1 : 0}};
        limit = "{{Request::get('perPage') ?? $dates->perPage()}}";
    </script>
    <script src="{{ asset('dashboard') }}/assets/js/influencer_travel/list.js"></script>
    <script>
        ...
        function exportData(lang) {
            ...
            location.href = "{{ route('influencer_travel.export' )}}?" + jQuery.param(params);
        }
