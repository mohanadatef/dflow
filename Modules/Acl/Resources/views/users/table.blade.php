                    ...
                    <tr id="remove{{$data->id}}">
                        ...
                        <td>
                            <div class="form-check form-switch form-switch-sm form-check-custom form-check-solid" >
                                <input class="form-check-input" type="checkbox" value="" name="notifications" {{$data->active ? 'checked' : ''}} onclick="toggleActive({{$data->id}})">
                                <label class="form-check-label" id="active-label-{{$data->id}}">{{$data->active ? getCustomTranslation('active') : getCustomTranslation('inactive')}}</label>
                            </div>
                        ...
                        <td class="text-end">
                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">{{getCustomTranslation('actions')}}
                                ...
                                <div class="menu-item px-3">
                                    @can('view_users')
                                    <a href="{{route('user.show',$data->id)}}" class="menu-link px-3">{{getCustomTranslation('view')}}</a>
                                    @endcan
                               ...
                               <div class="menu-item px-4">
                                ...
                                <a href="{{url('acl/user/password/'.$data->id)}}" class="menu-link px-3">{{getCustomTranslation('change_passsword')}}</a>
                                @endcan
