...
@section('title', getCustomTranslation('role'))
        ...
        <div class="flex-lg-row-fluid ms-lg-10">
            ...
            <div class="card card-flush mb-6 mb-xl-9">
                ...
                <div class="card-header pt-5">
                    <!--begin::Card title-->
                    <div class="card-title">
                        <h2 class="d-flex align-items-center">{{getCustomTranslation('users_assigned')}}
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none"
                            ...
                            <div class="fw-bold me-5">
                                <span class="me-2" data-kt-view-roles-table-select="selected_count"></span>{{getCustomTranslation('selected')}}
                            </div>
                            <button type="button" class="btn btn-danger"
                                    data-kt-view-roles-table-select="delete_selected">{{getCustomTranslation('delete_selected')}}
                            </button>
                        </div>
                        <!--end::Group actions-->
                    </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-50px">{{getCustomTranslation('id')}}</th>
                            <th class="min-w-150px">{{getCustomTranslation('user')}}</th>
                            <th class="min-w-125px">{{getCustomTranslation('joined_date')}}</th>
                            <th class="text-end min-w-100px">{{getCustomTranslation('actions')}}</th>
                        </tr>
                        <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('user.show', $user->id) }}"
                                               class="menu-link px-3">{{getCustomTranslation('view')}}</a>
                                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3"
                                               data-kt-roles-table-filter="delete_row">{{getCustomTranslation('delete')}}</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
