...
@section('content')
    <form id="kt_influencer_edit_form" class="form" method="post" action="{{route('influencer.update',$data->id)}}"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="text" name="contact_number" value="{{$data->contact_number}}" maxlength="14"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                        ...
                                        <div class="row" id="follower-{{$follower->platform_id}}">
                                            <div class="col-lg-6 fv-row">
                                                ...
                                                <input type="text"
                                                       ...
                                                       class="form-control form-control-lg form-control-solid mb-3 "
                                                       style="display: none" value="{{$follower->platform_id}}"/>
                                                <input type="text" name="platform_name" disabled
                                            ...
                                            <div class="col-lg-6 fv-row">
                                                ...
                                                <input type="text" name="follower[{{$follower->platform_id}}][url]"
                                                       value="{{$follower->url}}"
                                                       class="form-control form-control-lg form-control-solid mb-3 mb-lg-6"/>
                                            </div>
                                            <div class="col-lg-6 fv-row">
                                                ...
                                                <select name="follower[{{$follower->platform_id}}][size_id]"
                                                        aria-label="{{getCustomTranslation('follower_size')}}" data-control="select2"
                                                        data-placeholder="{{getCustomTranslation('follower_size')}}..."
                                                        class="form-select form-select-solid form-select-lg fw-semibold">
                                                    <option value="">{{getCustomTranslation('follower_size')}}...</option>
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                                            ...
                                            @foreach($data->influencer_country_audience as $country_audience)
                                                <div id='new_{{$count}}'>
                                                    ...
                                                    <div class="col-lg-6 fv-row">
                                                        ...
                                                        <input type="text" name="audienceCountry[{{$count}}][rate]"
                                            ...
                                            @foreach($data->influencer_category_audience as $category_audience)
                                                <div id='new_{{$count}}'>
                                                    ...
                                                    <div class="col-lg-6 fv-row">
                                                        <label
                                                                class="col-lg-4 col-form-label  fw-semibold fs-6">{{getCustomTranslation('rate')}}</label>
                                                        <input type="text" name="audienceCategory[{{$count}}][rate]"
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_influencer_edit_submit">{{getCustomTranslation('save_changes')}}
                    </button>
                </div>
                <!--end::Actions-->
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\Acl\Http\Requests\Influencer\EditRequest','#kt_influencer_edit_form') !!}
@endpush
