...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">{{getCustomTranslation('personal_info')}}  <br>{{getCustomTranslation('ad')}} : {{$data->ad_record->count()}}</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Content-->
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <!--begin::Col-->
                        <div>
                            <input disabled type="text" name="name_en" value="{{$data->name_en}}"
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <!--begin::Col-->
                        <div>
                            <input disabled type="text" name="name_ar" value="{{$data->name_ar}}"
                                   class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                    ...
                    <div class="row">
                        ...
                        <div>
                            <select disabled name="city_id[]"
                                    aria-label="{{getCustomTranslation('select_a_city')}}" id="city1"
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <!--begin::Col-->
                        <div>
                            <select disabled name="gender" aria-label="Gender"
                                    data-control="select2"
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <!--begin::Col-->
                        <div>
                            <input disabled type="date" name="birthdate" value="{{$data->birthdate}}"
                ...
                <div class="col-lg-8">
                    ...
                    <div class="image-input image-input-outline" data-kt-image-input="true"
                        ...
                        <label
                            ...
                            <!--begin::Inputs-->
                            <input disabled type="file" name="image" accept=".png, .jpg, .jpeg"/>
                            <input disabled type="hidden" name="image_remove"/>
                            <!--end::Inputs-->
                        </label>
                        <!--end::Label-->
                        <!--begin::Cancel-->
                    ...
                    <div class="row">
                        ...
                        <div id="service1">
                            @foreach($data->influencer_service_platform as $service)
                                <div class="row" id="service1-{{$service->platform_id}}">
                                    <div>
                                        ...
                                        <input disabled type="text" name="platform_name" disabled
                                               value="{{$service->platform->name_en.'/'.$service->platform->{'name_'.$lang} }}"
                                               class="form-control form-control-lg form-control-solid mb-3 "/>
                                        <input disabled type="text" name="service_name" disabled
                            ...
                            @foreach($data->platform as $p)
                                @foreach($p->service as $service)
                                    @if(!in_array($service->id,$data->influencer_service_platform->pluck('service_id')->toArray()))
                                        <div class="row" id="service1-{{$p->id}}">
                                            <div>
                                                <label class="col-lg-4 col-form-label w-100 required fw-semibold fs-6">{{getCustomTranslation('service_name')}}</label>
                                                <input disabled type="text"
                    ...
                    <div class="row">
                        ...
                        <div id="follower">
                            @foreach($data->influencer_follower_platform as $follower)
                                <div class="row" id="follower1-{{$follower->platform_id}}">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <select disabled name="follower[{{$follower->platform_id}}][size_id]"
...
<div class="card mb-5 mb-xl-10">
                    ...
                    <div class="row">
                        ...
                        @foreach(genderType() as $value)
                            <div>
                                ...
                                <input disabled type="text" name="genderPercentage[{{$value}}][gender]"
                                       class="form-control form-control-lg form-control-solid mb-3 "
                                       style="display: none" value="{{getCustomTranslation($value)}}"/>
                                <input disabled type="text" name="genderPercentage[{{$value}}][rate]"
                        ...
                        @endforeach
                        <!--end::Col-->
                        <div id="error-genderPercentage1" style="color: red"></div>
                    </div>
                    <!--end::Row-->
                </div>
                <!--end::Col-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row">
                            <div class="col-md-6">
                                    ...
                                    @foreach($data->influencer_country_audience as $country_audience)
                                        <div id='new_{{$count}}'>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-lg-12 fv-row">
                                                        <select disabled name="audienceCountry[{{$count}}][country_id]"
                                                                aria-label="{{getCustomTranslation('select_a_country')}}"
                                                                id="country_{{$count}}"
                                                                data-control="select2"
                                                                data-placeholder="{{getCustomTranslation('select_a_country')}}..."
                                ...
                                <input disabled type="hidden" value="{{$count-1}}" id="total_country_audience1">
                            </div>
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row">
                            <div class="col-md-6">
                                    ...
                                    @foreach($data->influencer_category_audience as $category_audience)
                                        <div id='new1_{{$count}}'>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-lg-12 fv-row">
                                                        <select disabled name="audienceCategory[{{$count}}][category_id]"
                                                                aria-label="{{getCustomTranslation('select_a_category')}}"
                                                                id="category_{{$count}}"
                                                                data-control="select2"
                                                                data-placeholder="{{getCustomTranslation('select_a_category')}}"
                                ...
                                <input disabled type="hidden" value="{{$count-1}}" id="total_category_audience1">
                            </div>
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <script>
        GetCity1({{json_encode($data->country->pluck('id')->toArray())}}, {{json_encode($data->city->pluck('id')->toArray())}});
        countGenderPercentage();
        //city list for country
        function GetCity1(country, city) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    for (let x in res) {
                        for (let i in res[x]) {
                            if (res[x][i].id == city || cityVal1.includes(`${res[x][i].id}`)) {
                                $(`#city1`).append(`<option value="${res[x][i].id}" selected>${res[x][i].name_en}/${res[x][i].name_ar}</option>`);
                            } else {
                                $(`#city1`).append(`<option value="${res[x][i].id}">${res[x][i].name_en}/${res[x][i].name_ar}</option>`);
                            }
                        }
        ...
        function GetService(add, remove) {
            ...
            if (remove[0] !== undefined) {
                $(`#service1 #service1-${remove[0]}`).remove();
            }
            if (add.length != 0) {
                $.ajax({
                    type: "GET",
                    ...
                    success: function (res) {
                        for (let x in res) {
                            for (let i in res[x]) {
                                var myEle = document.getElementById(`service1-${res[x][i].id}`);
                                if (myEle == null) {
                                    $(`#service1`).append(`<div class="row" id="service1-${res[x][i].id}"></div>`);
                                    for (let y in res[x][i].service) {
                                        $(`#service1 #service1-${res[x][i].id}`).append(`
                                <div>
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Service Name</label>
                                    <input disabled type="text" name="service[${res[x][i].id}][${res[x][i].service[y].id}][platform_id]" class="form-control form-control-lg form-control-solid mb-3 " style="display: none" value="${res[x][i].id}"/>
                                    <input disabled type="text" name="platform_name" disabled value="${res[x][i].name_en}/${res[x][i].name_ar}"
                                           class="form-control form-control-lg form-control-solid mb-3 "/>

                                    <input disabled type="text" name="service_name" disabled value="${res[x][i].service[y].name_en}/${res[x][i].service[y].name_ar}"
                                           class="form-control form-control-lg form-control-solid mb-3 "/>
                                    <input disabled type="text" name="service[${res[x][i].id}][${res[x][i].service[y].id}][service_id]"  class="form-control form-control-lg form-control-solid mb-3 " style="display: none" value="${res[x][i].service[y].id}"/>
                                </div>
                                <div>
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Service Price</label>
                                    <input disabled type="text" name="service[${res[x][i].id}][${res[x][i].service[y].id}][price]"  value="0"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-6"/>
                           </div>`);
                                    }
                                }
        ...
        function GetFollower(add, remove) {
            url = '{{ route("platform.list") }}';
            if (remove[0] !== undefined) {
                $(`#follower1 #follower1-${remove[0]}`).remove();
            }
            if (add.length != 0) {
                $.ajax({
                    type: "GET",
                    ...
                    success: function (res) {
                        for (let x in res) {
                            for (let i in res[x]) {
                                ...
                                if (myEle == null) {
                                    $(`#follower1`).append(`<div class="row" id="follower-${res[x][i].id}"></div>`);
                                    $(`#follower1 #follower1-${res[x][i].id}`).append(`
                                <div>
                                    <label class="col-lg-6 col-form-label w-100 fw-semibold fs-6">Platform Name</label>
                                    <input disabled type="text" name="follower[${res[x][i].id}][platform_id]" class="form-control form-control-lg form-control-solid mb-3 " style="display: none" value="${res[x][i].id}"/>
                                    <input disabled type="text" name="platform_name" disabled value="${res[x][i].name_en}/${res[x][i].name_ar}"
                                           class="form-control form-control-lg form-control-solid mb-3 "/>
                                </div>
                            <div>
                                    <label class="col-lg-6 col-form-label  fw-semibold fs-6">PLatform Url</label>
                                    <input disabled type="text" name="follower[${res[x][i].id}][url]"  value="0"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-6"/>
                           </div>
                            <div>
                                    <label class="col-lg-6 col-form-label  fw-semibold fs-6">Follower Size</label>
                                    <select disabled name="follower[${res[x][i].id}][size_id]" aria-label="Select a Size"  data-control="select2"
                                ...
                                <div>
                                        ...
                                        <input disabled type="text" name="follower[${res[x][i].id}][followers]"  value="0"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-6"/>
                           </div>`);
                                }
                            }
        ...
        function countGenderPercentage() {
            /*$('#error-genderPercentage1').empty();
            var count = 0;
            @foreach(genderType() as $value)
                count += parseInt(document.getElementById('genderPercentage1-{{$value}}').value);
            @endforeach
            if (count !== 100 && count !== 0) {
                $('#error-genderPercentage1').append('must count equal 100');
