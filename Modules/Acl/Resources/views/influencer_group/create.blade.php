    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_influencer_group_create_form" class="form" method="post"
                  action="{{route('influencer_group.store')}}">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <div>
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span id="influencer-count">0</span> <span>{{getCustomTranslation('influencers')}}</span>
                                    </label>
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span> {{getCustomTranslation('average_ads')}}</span><span id="ad-count">0</span>
                                    </label>
                                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('dashboard') }}/assets/js/influencer_group/create.js"></script>
    {!! JsValidator::formRequest('Modules\Acl\Http\Requests\InfluencerGroup\CreateRequest','#kt_influencer_group_create_form') !!}
