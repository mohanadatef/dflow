                ...
                <div class="fv-row mb-10">
                    ...
                    <div class="row">
                            ...
                            <label class="fs-5 fw-bold form-label mb-2">
                                <span >{{getCustomTranslation('date')}}  <span id="date_price">{{getCustomTranslation('date')}}</span></span>
                            </label>

                            <label class="fs-5 fw-bold form-label mb-2">
                                <span >{{getCustomTranslation('price')}}  <span id="price"></span></span>
                            </label>
...
function closemodelprice(){
    ...
    if (themeMode == 'light') {
        Highcharts.chart('container_price', {
            ...
            yAxis: {
                title: {
                    text: '{{getCustomTranslation('price_of_ads')}}'
                }
            },
            exporting: {
