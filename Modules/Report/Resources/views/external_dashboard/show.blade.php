...
@section('title', getCustomTranslation('show_external_dashboard'))
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{getCustomTranslation('show_external_dashboard')}}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <select id="search_company" name="company_id[]" disabled
                                            class="form-select form-select-solid form-select-lg fw-semibold"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <select id="search_user" name="users[]" disabled
                                            class="form-select form-select-solid form-select-lg fw-semibold"
                                            data-mce-placeholder="" multiple="multiple"
                                    >
