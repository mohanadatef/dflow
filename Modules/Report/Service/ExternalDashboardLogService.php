...
use Modules\Report\Repositories\ExternalDashboardLogRepository;

class ExternalDashboardLogService extends BasicService
{
    protected $repo;
     ...
     * @return void
     */
    public function __construct(ExternalDashboardLogRepository $repository)
    {
