...
use Modules\Record\Repositories\AdRecordDraftLogRepository;

class AdRecordDraftLogService extends BasicService
{
    protected $repo;
     ...
     * @return void
     */
    public function __construct(AdRecordDraftLogRepository $repository)
    {
