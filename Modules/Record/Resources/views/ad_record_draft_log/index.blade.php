...
@section('title', getCustomTranslation('log_ad_record_draft'))
    ...
    <div class="card card-flush">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div id="data-table" style="width: 100%">
                @include('record::ad_record_draft_log.table')
            </div>
            <!--end::Datatable-->
        </div>
    </div>
...
@push('scripts')
    ...
    var route = "{{ route('ad_record_draft_log.index') }}";
    ...
    function getData(url) {
        $.ajax({
            ...
            url: url,
            data:{
              'ad_record_draft_id':"{{Request('ad_record_draft_id')}}",
              'type':$("#type").val(),
                'created_at': $("#date").val(),
            },
