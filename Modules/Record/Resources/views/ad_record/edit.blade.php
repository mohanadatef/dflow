        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                ...
                <a id="create-error" href="#" onclick="getTimbrallyData({{$data->id}})"
                   class="btn btn-danger">{{getCustomTranslation('create_error')}}</a>
                @endcan
            </div>
            <!--end::Card title-->
        </div>
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form class="form" method="post" id="form"
                ...
                <div class="card-body border-top p-9">
                                    ...
                                    fill="currentColor"/>
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item px-3">
                                                        ...
                                                        <a id="create-error"
                                                           href="{{route('ad_record_errors.update') .'?error_id='. $error->id}}"
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <label class="fs-6 fw-semibold form-label mt-3 d-flex justify-content-between">
                                    ...
                                    <div style='display: block' id="edit-company-action">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1 select_company">
                                        ...
                                        >
                                            <option value="{{$data->company_id}}"
                                                    selected>{{$data->company->name_en .'/'.$data->company->name_ar}}</option>
                                        </select>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <!--begin::Input group-->
                            <div class="fv-row mb-7" id="promoted_products" @if(!empty($data->promoted_products)) style="display:block;" @else style="display:none;" @endif>
                                <!--begin::Label-->
                                <label class="fs-6 fw-semibold form-label mt-3">
                        ...
                        <div class="col">
                            ...
                            <!--begin::Input group-->
                            <div class="fv-row mb-7" id="promoted_offer" @if(!empty($data->promoted_offer)) style="display:block;" @else style="display:none;"  @endif>
                                <!--begin::Label-->
                                <label class="fs-6 fw-semibold form-label mt-3">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button id='btn' type="button" class="btn btn-primary" onclick="actionButton('edit')">{{getCustomTranslation('save_changes')}}
                    </button>
                    @if(count($data->ad_record_errors->where('action', 0)) > 0)
                    <button id='btn_solve' type="button" class="btn btn-primary" onclick="actionButton('solve')">{{getCustomTranslation('solve')}}
                    </button>
                    @endif
                </div>
                <!--end::Actions-->
            ...
            <div class="modal-dialog modal-dialog-centered mw-800px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-lg-5 my-7">
                        <!--begin::Form-->
                        <form id="kt_modal_timbrally_form" class="form" method="post" action=""
                              enctype="multipart/form-data">
                            @csrf
                            <!--begin::Scroll-->
...
@push('scripts')
    <script>
        function disableButton() {
            ...
            btn_solve.disabled = true;
            btn_solve.innerText = '{{getCustomTranslation('sending')}}...'
            @endif
        }
        function actionButton(type) {
            disableButton();
            if (type == 'edit') {
                document.getElementById('form').action = "{{route('ad_record.update', $data->id)}}";
            }
            if (type == 'solve') {
                document.getElementById('form').action = "{{route('ad_record.update',['id'=> $data->id,'solve'=>1])}}";
            }
            this.form.submit();
        }
        ...
        GetCategory({{$data->company_id}}, {{$data->category->pluck('id')}})
        ...
        GetService({{$data->platform_id}}, {{json_encode($data->service->pluck('id')->toArray())}})
    ...
    <script>
        ...
        var companyValue = @json($data->company_id);
        ...
        let myDropzone = new Dropzone("#kt_modal_create_project_settings_logo", {
            init: function () {
                ...
                let dropzone = this;
                $.ajax({
                    url: "{{ route('ad_record.read_files')}}?module=adrecord&id=" + {{$data->id}},
                    type: 'get',
                    data: {request: 'fetch'},
                    dataType: 'json',
