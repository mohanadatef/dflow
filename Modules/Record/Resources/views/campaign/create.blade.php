    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{getCustomTranslation('campaign')}}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_campaign_create_form" class="form" method="post" action="{{route('campaign.store')}}">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input type="text" name="url" value="{{Request::old('url')}}"
                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\Record\Http\Requests\Campaign\CreateRequest','#kt_campaign_create_form') !!}
@endpush
