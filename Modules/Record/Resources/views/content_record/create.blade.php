...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
             data-bs-target="#kt_content_record_create" aria-expanded="true"
             aria-controls="kt_content_record_create">
            <!--begin::Card title-->
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_content_record_create_form" class="form" method="post"
                  action="{{route('content_record.store')}}"
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="video-input-container">
                                <label for="video-input video-input col-form-label">{{getCustomTranslation('select_a_video_from_your_computer')}}
                                    <br> {{getCustomTranslation('allowed_file_types')}}: mp4,mov,ogg </label> <input
                                        type="file" id="video-input" class="video" name="video" accept="video/mp4">
                            </div>

                            <div class="player d-none">
                                <video src="" controls autoplay muted loop class="player-video-viewer"></video>
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary"
                            id="kt_influencer_create_submit">{{getCustomTranslation('save_changes')}}
                    </button>
                </div>
                <!--end::Actions-->
            </form>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('Modules\Record\Http\Requests\ContentRecord\CreateRequest','#kt_content_record_create_form') !!}
@endpush
