...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="form" class="form" method="post" action="{{route('support_center.store')}}"
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    <select name="is_answered" id="is_answered" aria-label="{{getCustomTranslation('answered')}}"
                                        ...
                                        <option value="1">{{getCustomTranslation('answered')}}</option>
                                        <option value="0">{{getCustomTranslation('not_answered')}}</option>
                        ...
                        <!--end::Col-->
                    </div>                    <div class="row row-cols-1 row-cols-sm-1 rol-cols-md-1 row-cols-lg-1">
                            <!--begin::Col-->
                            <div class="col">
                                <!--begin::Input group-->
