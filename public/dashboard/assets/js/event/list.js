...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_event_table_new").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            stateSave: true,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function (data, type, row) {
                        var deletePermissio = deletePermission ? `<a href="#" data-kt-event-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>` : "";
    ...
    // Search Datatable --- official event reference: https://datatables.net/reference/api/search()
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-event-table-filter="group"] [name="group"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official event reference: https://datatables.net/reference/api/search()
        ...
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    // SweetAlert2 pop up --- official event reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
    ...
    var handleResetForm = () => {
        ...
        if (resetButton) {
            ...
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official event reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_event_table_new");
        const checkboxes = container.querySelectorAll('[type="checkbox"]');


        // Select elements
        const deleteSelected = document.querySelector(
            '[data-kt-event-table-select="delete_selected"]'
        );
    ...
    var toggleToolbars = function () {
        ...
        const toolbarBase = document.querySelector(
            '[data-kt-event-table-select="base"]'
        );
        const toolbarSelected = document.querySelector(
            '[data-kt-event-table-select="selected"]'
        );
        const selectedCount = document.querySelector(
            '[data-kt-event-table-select="selected_count"]'
        );
