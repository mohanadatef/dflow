...
var KTDatatablesServerSide = (function () {
        ...
        dt = $("#kt_company_table").DataTable(/*{
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function (data, type, row) {
                        var deletePermissio =   deletePermission  ? `<a href="#" data-kt-company-table-filter="delete_row" class="menu-link px-3">Delete</a>` : "";
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-company-table-filter="group"] [name="group"]'
        );
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_company_table");
    ...
    var toggleToolbars = function () {
        ...
        const toolbarBase = document.querySelector(
            '[data-kt-company-table-select="base"]'
        );
        const toolbarSelected = document.querySelector(
            '[data-kt-company-table-select="selected"]'
        );
