...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_promotion-type_table").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            stateSave: true,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var deletePermissio = deletePermission ? `<a href="#" data-kt-promotion-type-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>` : "";
    ...
    // Search Datatable --- official promotion-type reference: https://datatables.net/reference/api/search()
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector(
            '[data-kt-promotion-type-table-filter="search"]'
        );
        if (filterSearch) {
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-promotion-type-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-promotion-type-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official promotion-type reference: https://datatables.net/reference/api/search()
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll(
            '[data-kt-promotion-type-table-filter="delete_row"]'
        );
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    // SweetAlert2 pop up --- official promotion-type reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-promotion-type-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official promotion-type reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_promotion-type_table");
