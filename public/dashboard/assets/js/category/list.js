...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_customers_table_new").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            stateSave: true,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function (data, type, row) {
                        var deletePermissio = deletePermission ? `<a href="#" data-kt-category-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>` : "";
    ...
    // Search Datatable --- official category reference: https://datatables.net/reference/api/search()
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-category-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-category-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official category reference: https://datatables.net/reference/api/search()
        ...
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    // SweetAlert2 pop up --- official category reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
    ...
    var handleResetForm = () => {
        ...
        if (resetButton) {
            ...
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official category reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_customers_table_new");
    ...
    var toggleToolbars = function () {
        ...
        const toolbarBase = document.querySelector(
            '[data-kt-category-table-select="base"]'
        );
        const toolbarSelected = document.querySelector(
            '[data-kt-category-table-select="selected"]'
        );
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.status == 'false') {
                Swal.fire({
                    text: categoryParentIsNotActivatedText,
                    icon: "error",
                    buttonsStyling: false,
                    confirmButtonText: ok_got_it,
                    customClass: {
