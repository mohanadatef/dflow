...
var KTDatatablesServerSide = (function () {
        ...
        dt = $("#kt_customers_table_new").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function (data, type, row) {
                        var deletePermissio = deletePermission ? `<a href="#" data-kt-location-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>` : "";
    ...
    // Search Datatable --- official location reference: https://datatables.net/reference/api/search()
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector(
            '[data-kt-location-table-filter="search"]'
        );
        if (filterSearch) {
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-location-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-location-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official location reference: https://datatables.net/reference/api/search()
        ...
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    // SweetAlert2 pop up --- official location reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-location-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official location reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var toggleToolbars = function () {
        ...
        const toolbarBase = document.querySelector(
            '[data-kt-location-table-select="base"]'
        );
        const toolbarSelected = document.querySelector(
            '[data-kt-location-table-select="selected"]'
        );
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.status == 'false') {
                Swal.fire({
                    text: locationParentIsNotActivatedText,
                    icon: "error",
                    buttonsStyling: false,
                    confirmButtonText: ok_got_it,
                    customClass: {
