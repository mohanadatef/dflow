...
var KTDatatablesServerSide = (function () {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var deletePermissio = `<a href="#" data-kt-calendar-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>`;
                        var updatePermissio = `<a href="` + route + `/` + data.id + `/edit" class="menu-link px-3">`+ getCustomTranslationEdit +`</a>`;
                        return (
                            `
    ...
    // Search Datatable --- official calendar reference: https://datatables.net/reference/api/search()
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector(
            '[data-kt-calendar-table-filter="search"]'
        );
        if (filterSearch) {
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-calendar-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-calendar-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official calendar reference: https://datatables.net/reference/api/search()
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll(
            '[data-kt-calendar-table-filter="delete_row"]'
        );
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    // SweetAlert2 pop up --- official calendar reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-calendar-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official calendar reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
