...
var KTDatatablesServerSide = (function () {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var deletePermissio = deletePermission ? `<a href="#" data-kt-interest-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>` : "";
    ...
    // Search Datatable --- official interest reference: https://datatables.net/reference/api/search()
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector(
            '[data-kt-interest-table-filter="search"]'
        );
        if (filterSearch) {
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-interest-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-interest-table-filter="filter"]'
        );
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll(
            '[data-kt-interest-table-filter="delete_row"]'
        );
        if (deleteButtons) {
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-interest-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
