...
var KTDatatablesServerSide = (function () {
        ...
        dt = $("#kt_clients_table").DataTable(/*{
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function (data, type, row) {
                        var deletePermissio =   deletePermission  ? `<a href="#" data-kt-clients-table-filter="delete_row" class="menu-link px-3">Delete</a>` : "";
    ...
    // Search Datatable --- official clients reference: https://datatables.net/reference/api/search()
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-clients-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-clients-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official clients reference: https://datatables.net/reference/api/search()
        ...
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    // SweetAlert2 pop up --- official clients reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-clients-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official clients reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_clients_table");
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector(
            '[data-kt-clients-table-select="delete_selected"]'
        );
    ...
    var toggleToolbars = function () {
        ...
        const toolbarBase = document.querySelector(
            '[data-kt-clients-table-select="base"]'
        );
        const toolbarSelected = document.querySelector(
            '[data-kt-clients-table-select="selected"]'
        );
        const selectedCount = document.querySelector(
            '[data-kt-clients-table-select="selected_count"]'
        );
