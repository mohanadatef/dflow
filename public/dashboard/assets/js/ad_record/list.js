...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        ...
        dt = $("#kt_ad_record_table").DataTable(/*{
            searchDelay: 500,
            processing: true,
            serverSide: true,
            stateSave: true,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var deletePermissio =   deletePermission  ? `<a href="#" data-kt-ad_record-table-filter="delete_row" class="menu-link px-3">Delete</a>` : "";
    ...
    // Search Datatable --- official ad_record reference: https://datatables.net/reference/api/search()
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector(
            '[data-kt-ad_record-table-filter="search"]'
        );
        if (filterSearch) {
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-ad_record-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-ad_record-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official ad_record reference: https://datatables.net/reference/api/search()
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-ad_record-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official ad_record reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_ad_record_table");
        const checkboxes = container.querySelectorAll('[type="checkbox"]');


        // Select elements
        const deleteSelected = document.querySelector(
            '[data-kt-ad_record-table-select="delete_selected"]'
        );
