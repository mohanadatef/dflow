...
var KTDatatablesServerSide = (function () {
        ...
        dt = $("#kt_tag_table_new").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function (data, type, row) {
                        var deletePermissio = deletePermission ? `<a href="#" data-kt-tag-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>` : "";
    ...
    // Search Datatable --- official tag reference: https://datatables.net/reference/api/search()
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-tag-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-tag-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official tag reference: https://datatables.net/reference/api/search()
        ...
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    // SweetAlert2 pop up --- official tag reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-tag-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official tag reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_tag_table_new");
        const checkboxes = container.querySelectorAll('[type="checkbox"]');


        // Select elements
        const deleteSelected = document.querySelector(
            '[data-kt-tag-table-select="delete_selected"]'
        );
    ...
    var toggleToolbars = function () {
        ...
        const toolbarBase = document.querySelector(
            '[data-kt-tag-table-select="base"]'
        );
        const toolbarSelected = document.querySelector(
            '[data-kt-tag-table-select="selected"]'
        );
        const selectedCount = document.querySelector(
            '[data-kt-tag-table-select="selected_count"]'
        );
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.status == 'false') {
                Swal.fire({
                    text: tagParentIsNotActivatedText,
                    icon: "error",
                    buttonsStyling: false,
                    confirmButtonText: ok_got_it,
                    customClass: {
