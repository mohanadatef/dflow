                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_country" class="menu-link px-3" onclick="loadCountry(` + row.id + `)">`+ getCustomTranslationEdit +`</a>
                            </div>
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" data-kt-users-table-filter="delete_row" class="menu-link px-3">`+ getCustomTranslationDelete +`</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                            </div>
