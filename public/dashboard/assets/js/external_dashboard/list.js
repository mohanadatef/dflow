...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        dt = $("#kt-external-dashboard-table").DataTable(/*{
            searchDelay: 500,
            processing: true,
            serverSide: true,
            stateSave: true,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function (data, type, row) {
                        var deletePermissio =   deletePermission  ? `<a href="#" data-kt-external-dashboard-table-filter="delete_row" class="menu-link px-3">Delete</a>` : "";
    ...
    // Search Datatable --- official company reference: https://datatables.net/reference/api/search()
    // var handleSearchDatatable = function () {
    //     const filterSearch = document.querySelector(
    //         '[data-kt-external-dashboard-table-filter="search"]'
    //     );
    //     if (filterSearch) {
    ...
    var handleFilterDatatable = () => {
        ...
        filterPayment = document.querySelectorAll(
            '[data-kt-external-dashboard-table-filter="group"] [name="group"]'
        );
        const filterButton = document.querySelector(
            '[data-kt-external-dashboard-table-filter="filter"]'
        );
        ...
        if (filterButton) {
            ...
            filterButton.addEventListener("click", function () {
                ...
                // Filter datatable --- official company reference: https://datatables.net/reference/api/search()
        ...
        if (deleteButtons) {
            deleteButtons.forEach((d) => {
                ...
                d.addEventListener("click", function (e) {
                    ...
                    const companyId = parent.querySelectorAll("td div input")[0].value;

                    // SweetAlert2 pop up --- official company reference: https://sweetalert2.github.io/
                    Swal.fire({
                        text:
                        ...
                        if (result.value) {
                            ...
                            Swal.fire({
                                text: companyName + was_not_deleted,
                                icon: "error",
                                buttonsStyling: false,
                                confirmButtonText: ok_got_it,
                                customClass: {
    ...
    var handleResetForm = () => {
        ...
        const resetButton = document.querySelector(
            '[data-kt-external-dashboard-table-filter="reset"]'
        );
        if (resetButton) {
            // Reset datatable
            resetButton.addEventListener("click", function () {
                ...
                // Reset datatable --- official company reference: https://datatables.net/reference/api/search()
                dt.search("").draw();
            });
        }
    };
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt-external-dashboard-table");
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector(
            '[data-kt-external-dashboard-table-select="delete_selected"]'
        );
    ...
    var toggleToolbars = function () {
        ...
        const toolbarBase = document.querySelector(
            '[data-kt-external-dashboard-table-select="base"]'
        );
        const toolbarSelected = document.querySelector(
            '[data-kt-external-dashboard-table-select="selected"]'
        );
        const selectedCount = document.querySelector(
            '[data-kt-external-dashboard-table-select="selected_count"]'
        );
