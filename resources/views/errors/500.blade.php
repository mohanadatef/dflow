...
<head>
    <base href="{{url('/')}}">
    <title>{{getCustomTranslation('dflow_500')}}</title>
    <meta charset="utf-8"/>
        ...
        <div class="d-flex flex-column flex-center text-center p-10">
            ...
            <div class="card card-flush w-lg-650px py-5">
                <div class="card-body py-15 py-lg-20">
                    <!--begin::Title-->
                    <h1 class="fw-bolder fs-2hx text-gray-900 mb-4">{{getCustomTranslation('system_error')}}</h1>
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="fw-semibold fs-6 text-gray-500 mb-7">{{getCustomTranslation('something_went_wrong_please_try_again_later_or_contact_administrator')}}
                    </div>
                    <!--end::Text-->
                    <!--begin::Illustration-->
                    <div class="mb-3">
                        <img src="{{asset('dashboard')}}/assets/media/auth/500-error.png"
                             class="mw-100 mh-300px theme-light-show" alt="">
                        <img src="{{asset('dashboard')}}assets/media/auth/500-error-dark.png"
