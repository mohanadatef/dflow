<div id="kt_header" class="header py-6 py-lg-0" data-kt-sticky="true" data-kt-sticky-name="header"
     ...
     style="background-image:url('{{ asset('dashboard') }}/assets/header_background.png');background-repeat:no-repeat;background-size:cover">
    <!--begin::Container-->
    <div class="header-container container-xxl">
        ...
        <div
            ...
            <h1 class="d-flex flex-column text-dark fw-bold my-1">
                ...
                <small class="text-gray-600 fs-6 fw-normal pt-2">@yield('breadcrumb')</small>
            </h1>
            <!--end::Heading-->
        </div>
        <!--end::Page title=-->
            ...
            <div class="d-flex align-items-center py-3 py-lg-0">
                ...
                <div class="me-3">
                    <a href="#" class="btn btn-icon btn-custom btn-active-color-primary" data-kt-menu-trigger="click"
                       data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end"><span style="color: red" id="notification-count"></span>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            data-kt-menu="true" id="notification-user">
                        <!--begin::Menu item-->
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <a href="{{Route('user.show',user()->id)}}"
                               class="menu-link px-5">{{getCustomTranslation('my_profile')}}</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{Route('user.changePassword',user()->id)}}"
                               class="menu-link px-5">{{getCustomTranslation('change_password')}}</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{Route('supportCenter.faq')}}"
                               class="menu-link px-5">{{getCustomTranslation('faq')}}</a>
                        </div>

                        <div class="menu-item px-5">
                            <a href="{{Route('question.myQuestions')}}"
                               class="menu-link px-5">{{getCustomTranslation('question')}}</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-5">
                            <a href="{{Route('contact.create')}}"
                               class="menu-link px-5">{{getCustomTranslation('contact_us')}}</a>
                        </div>
                        @if($userLogin->access_media_ad == 0)
                            <div class="menu-item px-5">
                                <p style="pointer-events: none"
                                   class="menu-link px-5">{{getCustomTranslation('your_balance')}}
                                    : {{user()->unlimit_balance ? 'unlimit balance' : user()->balance}}</p>
                            </div>
                        @endif
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column" style="
                                overflow: auto;">
                                    <div class="menu-item px-5">{{getCustomTranslation('exact_match_search')}}
                                        {{--<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>--}}</div>
                                    <div class="menu-item px-5 fw-semibold text-muted text-hover-primary fs-7 form-check form-switch form-switch-sm form-check-custom form-check-solid">
                                        <input
                                                class="form-check-input" type="checkbox" value="" name="notifications"
                                                {{user()->match_search == 0 ? 'checked' :''}} onclick="toggleSearch({{user()->id}})">
                                        <label class="form-check-label"
                                               id="search-label-1-{{user()->id}}">{{user()->match_search == 0 ? getCustomTranslation('active')  : getCustomTranslation('inactive')}}</label>
                                    </div>
                                </div>
                                <!--end::Username-->
                            </div>
                ...
                <div class="d-flex align-items-center ms-1">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px"
                        ...
                        <div class="menu-item px-3 my-0">
                            ...
                            <span class="menu-icon" data-kt-element="icon">
                                ...
                                <span class="menu-title">{{getCustomTranslation('light')}}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            ...
                            <span class="menu-icon" data-kt-element="icon">
                                ...
                                <span class="menu-title">{{getCustomTranslation('dark')}}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    ...
                    <div class="d-flex align-items-center ms-1">
                        <!--begin::Menu toggle-->
                        <a href="#"
                           class=" btn-color-white bg-hover-white bg-hover-opacity-10  btn "
                           data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent"
                           data-kt-menu-placement="bottom-end">
                            {{getCustomTranslation('language')}}
                        </a>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3 my-0">
                                <a href="#" class="menu-link px-3 py-2" data-kt-element="language" data-kt-value="en"
                                   onclick="language('en')">
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3 my-0">
                                <a href="#" class="menu-link px-3 py-2" data-kt-element="language" data-kt-value="ar"
                                   onclick="language('ar')">
                ...
                <!--end::Theme mode--> <!--end::Theme mode-->
                @canany(['create_ad_record','create_influencer_trend'])
                    <div class="d-flex align-items-center ms-1">
                        <!--begin::Menu toggle-->
                        <a href="#"
                           class=" btn-color-white bg-hover-white bg-hover-opacity-10  btn"
                           data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent"
                           data-kt-menu-placement="bottom-end" style="background-color: red">
                            {{getCustomTranslation('quick_actions')}}
                        </a>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px"
                            ...
                            <div class="menu-item px-3 my-0">
                                <a href="{{route('ad_record.create')}}" class="menu-link px-3 py-2" target="_blank">
                                    <span class="menu-title">{{getCustomTranslation('add_ad_record')}}</span>
                                </a>
                            </div>
                            @endcan
                            <!--end::Menu item-->
                            @can('create_influencer_trend')
                                <div class="menu-item px-3 my-0">
                                    <a href="{{route('influencer_trend.create')}}" class="menu-link px-3 py-2" target="_blank">
                                        <span class="menu-title">{{getCustomTranslation('add_influencer_trend')}}</span>
                                    </a>
                                </div>
                            @endcan
                        </div>
