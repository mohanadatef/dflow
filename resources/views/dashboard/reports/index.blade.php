                            ...
                            <div class="px-7 py-5" data-kt-user-table-filter="form">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" name="platform" value="{{request('platform')}}"
                                           class="form-control" placeholder="Search by platform ..."/>
                                </div>
                                <!--end::Input group-->
                                ...
                                <form action="{{ route('reports.upload') }}" method="POST" enctype="multipart/form-data" class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div>
                                            ...
                                            <!-- <a class="btn btn-success" href="{{ route('reports.upload') }}">Export data</a> -->
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="kt_report_table"
                                ...
                                <tr>
                                    ...
                                    <th class="min-w-90px">Platform</th>
                                    <th class="min-w-90px">Identifier</th>
                                    <th class="min-w-90px">type</th>
                                    <th class="min-w-90px">License status</th>
                                    <th class="min-w-100px">Status date</th>
                                    <th class="min-w-90px">Advertised party</th>
                                    <th class="min-w-90px">Advertise category</th>
                                    <th class="min-w-100px">Report date</th>
                                    <th class="min-w-90px">Advertise url</th>
