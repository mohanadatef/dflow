...
<form action="{{route('competitive_analysis.viewPost')}}" method="POST" class="row g-6 g-xl-9">
    @csrf
            ...
            <div class="card border-transparent" data-theme="light" style="background-color: #1C325E;">
                ...
                <div class="card-body d-flex ps-xl-15">
                    ...
                    <div class="m-0">
                        ...
                        <span class="me-2">You can insert social data For
                        <span class="position-relative d-inline-block text-danger">
                            <span class="text-danger opacity-75-hover">Each competitor</span>
                            <!--begin::Separator-->
                            <span class="position-absolute opacity-50 bottom-0 start-0 border-4 border-danger border-bottom w-100"></span>
                            <!--end::Separator-->
                        </span></span>
                        <br>Update fields bellow then generate pdf ...</div>
                        <!--end::Title-->
                        <!--begin::Action-->
                        <div class="mb-3">
                            <a href="{{route('competitive_analysis',['company_id'=>request('company_id'), 'ranges' => request('ranges')])}}" class="btn btn-danger fw-semibold px-6 py-3">Change Time range</a>
                            <button type="submit" class="btn btn-success fw-semibold px-6 py-3">Generate PDF</button>
                        </div>
                        <!--begin::Action-->
                    </div>
                    <!--begin::Wrapper-->
                ...
                <div class="card card-flush mb-xxl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-dark">{{ $competitor['company']->name_en }}</span>
                            <span class="text-gray-400 pt-2 fw-semibold fs-6">
                                All possible company platforms
                            </span>
                        </h3>
                        <!--end::Title-->
                        ...
                        <ul class="nav nav-pills nav-pills-custom mb-3" role="tablist">
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                ...
                                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_1_tab_{{$competitor['company']->id}}_{{$platform->id}}" aria-selected="false" role="tab" tabindex="-1">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <span class="nav-text text-gray-700 fw-bold fs-6 lh-1">{{ $platform->name_en }}</span>
                                    <!--end::Subtitle-->
                                    <!--begin::Bullet-->
    ...
    @else
        <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-5 mb-xl-8" style="background-color: ;background-position: 100% 50px;background-size: 500px auto;background-image:url('{{asset('dashboard/assets/media/misc/city.png')}}')">
            ...
            <div class="card-body d-flex flex-column justify-content-center ps-lg-12">
                <!--begin::Title-->
                <h3 class="text-white fs-2qx fw-bold mb-7">No competitors
                <br>to show in this time range</h3>
                <!--end::Title-->
                <!--begin::Action-->
                <div class="m-0">
                    <a href="{{route('competitive_analysis',['company_id'=>request('company_id'), 'ranges' => request('ranges')])}}" class="btn btn-danger fw-semibold px-6 py-3">Change Time range</a>
